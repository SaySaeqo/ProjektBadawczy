...
import string
import numpy as nmp
from Functions import sigmoid,mul_matrix_scalar
...
class network:
    ...
    def __init__(self,nrn_nmb,correct_function):
        ...
        '''tablica macierzy wag'''
        self.biases=[None]*(self.layers)
        '''tablica tablic biasów'''
        self.nrn_nmb=nrn_nmb
        '''tablica liczby neuronów na warstwę'''
        self.neuron_values=[None]*(self.layers)
        '''tablica list wartości aktywacji neuronów'''
